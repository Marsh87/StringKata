...
namespace PlayerStringKata
{
    public class TestStringCalculator : ITestPack<IStringCalculator>
    {
        ...
        [Test]
        public void Add_GivenNumbertwo_ShouldReturntwo() {
            //---------------Set up test pack-------------------
            var calcultor = CreateCalculator();
            //---------------Assert Precondition----------------

            //---------------Execute Test ----------------------
            var result = calcultor.Add("2");
            //---------------Test Result -----------------------

            Assert.AreEqual(2,result);        
        }[Test]
        public void Add_GivenNumberthree_ShouldReturnthree() {
            //---------------Set up test pack-------------------
            var calcultor = CreateCalculator();
            //---------------Assert Precondition----------------

            //---------------Execute Test ----------------------
            var result = calcultor.Add("3");
            //---------------Test Result -----------------------
        ...
        public void Add_GiventwoNumbers_ShouldReturnSum() {
            //---------------Set up test pack-------------------
            var calcultator = CreateCalculator();
            //---------------Assert Precondition----------------

            //---------------Execute Test ----------------------

            //---------------Test Result -----------------------
            var result = calcultator.Add("1,2");
            Assert.AreEqual(3,result);
        }
        [Test]
        public void Add_GiventwoNumbersSecondTest_ShouldReturnSum() {
            //---------------Set up test pack-------------------
            var calcultator = CreateCalculator();
            //---------------Assert Precondition----------------
            ...
            //---------------Test Result -----------------------
            var result = calcultator.Add("2,3");
            Assert.AreEqual(5,result);
        }
        [Test]
        public void Add_GiventwoNumbersThirdtest_ShouldReturnSum() {
            //---------------Set up test pack-------------------
            var calcultator = CreateCalculator();
            //---------------Assert Precondition----------------
            ...
            //---------------Test Result -----------------------
            var result = calcultator.Add("3,4");
            Assert.AreEqual(7,result);
        }
        [Test]
        public void Add_GiventwoNumbersFourthtest_ShouldReturnSum() {
            //---------------Set up test pack-------------------
            var calcultator = CreateCalculator();
            //---------------Assert Precondition----------------
            ...
            //---------------Test Result -----------------------
            var result = calcultator.Add("5,6");
            Assert.AreEqual(11,result);
        }
        [Test]
        public void Add_GivenNumbersSeperatedbyComma_ShouldReturnSum() {
            //---------------Set up test pack-------------------
            var calcultator = CreateCalculator();
            //---------------Assert Precondition----------------
            ...
            //---------------Test Result -----------------------
            var result = calcultator.Add("1,2,3");
            Assert.AreEqual(6,result);
        }
        [Test]
        public void Add_GivenNumbersSeperatedbyCommaAndNewLine_ShouldReturnSum() {
            //---------------Set up test pack-------------------
            var calcultator = CreateCalculator();
            //---------------Assert Precondition----------------
        ...
        [Test]
        public void Add_GivenNegativeNumberOne_ShouldThrowNegativesNotAllowedException() {
            //---------------Set up test pack-------------------
            var calculator = CreateCalculator();
            //---------------Assert Precondition----------------
            ...
            //---------------Test Result -----------------------
       NegativesNotAllowedException exception  =  Assert.Throws<NegativesNotAllowedException>(() => calculator.Add("-1"));

           CollectionAssert.Contains(exception.NegativeNumbers,-1);
        }
        //[Test]
        //public void Add_GivenPositiveandNegativeNumbers_ShouldThrowNegativesNotAllowedException() {
        //    //---------------Set up test pack-------------------
        //    var calculator = CreateCalculator();
        //    //---------------Assert Precondition----------------
        ...
        //    Assert.Throws<NegativesNotAllowedException>(() => calculator.Add("-1,2"));
        //} [Test]
        //public void Add_GivenPositiveandtwoNegativeNumbers_ShouldThrowNegativesNotAllowedException() {
        //    //---------------Set up test pack-------------------
        //    var calculator = CreateCalculator();
        //    //---------------Assert Precondition----------------
