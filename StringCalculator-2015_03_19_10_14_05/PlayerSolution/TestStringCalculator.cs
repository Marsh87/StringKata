...
namespace PlayerStringKata
{
    public class TestStringCalculator : ITestPack<IStringCalculator>
    {
        ...
        [Test]
        public void Add_GivenThreeStringNumbersSeperatedByCommaWithNumberGreaterThan1000_ShouldNotReturnSumThatIncludesNumber() {
            //---------------Set up test pack-------------------
            var expected = 3;
            var input = "1,2,1001";
            var sut = CreateCalculator();
        ...
        [Test]
        public void Add_GivenThreeStringNumbersSeperatedByCommaEqualTO1000_ShouldReturnSumThatIncludesNumber() {
            //---------------Set up test pack-------------------
            var expected = 1003;
            var input = "1,2,1000";
            var sut = CreateCalculator();
        ...
        [Test]
        public void Add_GivenThreeStringNumbersSeperatedByNewLine_ShouldReturnIntegerValue() {
            //---------------Set up test pack-------------------
            var expected = 6;
            var input = "1,2\n3";
            var sut = CreateCalculator();
        ...
        [Test]
        public void Add_GivenThreeStringNumbersSeperatedByCustomDelimiterofVaryingType_ShouldReturnIntegerValue() {
            //---------------Set up test pack-------------------
            var expected = 6;
            var input = "//[*][%]\n1*2%3";
            var sut = CreateCalculator();
