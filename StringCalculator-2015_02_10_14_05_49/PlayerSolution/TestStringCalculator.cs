...
/*
  ...
  4.  Support different delimiters 
	  ...
	  4.2.	the first line is optional. All existing scenarios should still be 
			supported.
  5.  Calling Add with a negative number will throw the provided 
	NegativesNotAllowedException that will show the negative that was passed in. 
...
namespace PlayerStringKata
{
	public class TestStringCalculator : ITestPack<IStringCalculator>
	{
		...
		public void Constructor()
		{
			...
			//---------------Execute Test ----------------------
			IStringCalculator calculator = CreateCalculator();
			//---------------Test Result -----------------------
			Assert.IsNotNull(calculator);
		}

		[Test]
		public void If_Empty_String_Is_Entered()
		{
			//---------------Set up test pack-------------------

			int calulator = CreateCalculator().Add("");
			...
			//---------------Test Result -----------------------
			Assert.AreEqual(0, calulator);
		}

		[Test]
		public void InputNumberIsEqualToOutputValue()
		{
			//---------------Set up test pack-------------------

			int calulator = CreateCalculator().Add("1");
			...
			//---------------Test Result -----------------------
			Assert.AreEqual(1, calulator);
		}

		[Test]
		public void InputTwoNumber_Seperated_By_Comma_Outputs_Sum()
		{
			//---------------Set up test pack-------------------

			int calulator = CreateCalculator().Add("1,2");
			...
			//---------------Test Result -----------------------
			Assert.AreEqual(3, calulator);
		}

		[Test]
		public void InputTwoNumber_Seperated_By_Comma_Outputs_Sum_Second_Test()
		{
			//---------------Set up test pack-------------------
			...
			//---------------Execute Test ----------------------
			int result = CreateCalculator().Add("3,4");
			//---------------Test Result -----------------------
			Assert.AreEqual(7, result);
		}

		[Test]
		public void Numbers_Seperated_By_Comma_Outputs_Sum_Second()
		{
			//---------------Set up test pack-------------------
			IStringCalculator calculator = CreateCalculator();
			//---------------Assert Precondition----------------
		...
		[Test]
		public void Numbers_OnNewLineBy_Outputs_Sum()
		{
			//---------------Set up test pack-------------------
			IStringCalculator calculator = CreateCalculator();
			//---------------Assert Precondition----------------
		...
		[Test]
		public void DifferertDelimiter()
		{
			//---------------Set up test pack-------------------
			IStringCalculator calculator = CreateCalculator();
			//---------------Assert Precondition----------------
		...
		[Test]
		public void NegativeNumberThrowNoNegativesAllowed()
		{
			//---------------Set up test pack-------------------
			IStringCalculator calculator = CreateCalculator();
			//---------------Assert Precondition----------------
		...
		[Test]
		public void NegativeNumbersThrowNoNegativesAllowed()
		{
			//---------------Set up test pack-------------------
			IStringCalculator calculator = CreateCalculator();
			//---------------Assert Precondition----------------
